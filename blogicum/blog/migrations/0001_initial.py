# Generated by Django 3.2.16 on 2025-05-19 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Разрешены латиница, цифры, дефис и подчёркивание.', unique=True, verbose_name='Идентификатор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если поставить в будущем — публикация отложится.', verbose_name='Дата и время публикации')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Добавлено')),
